# Woodburn Insurance - Your Issues

![Woodburn Insurance - Your Issues Script Application](../readme_imgs/YourIssues.png)
...
1. Update the project [WBIYourIssues/package.json](./package.json) file to point to the target DX core instance.
    ```
    {
        "config": {
           "dxclient": {
               "wcmContentName": "wbi-dashboard-your-issues",
               ...
               "protocol": "https",
               "hostname": "localhost",
               "port": "10041"
...
5. In case of errors, check the details in the DXClient logs in the WBIYourIssues/store/logs/logger.log file.
6. Prepare your target DX page that will host the WBIYourIssues ScriptApp. Follow the steps listed [here](https://pages.git.cwp.pnp-hcl.com/CWPdoc/dx-mkdocs/in-progress/resources/tutorials/scriptapps/common-setup/post-deployment/prepare_dx_page/).
7. Add the WBIYourIssues ScriptApp (matching the wcmContentName in the package.json config) into the target DX test page. Follow the steps listed [here](https://pages.git.cwp.pnp-hcl.com/CWPdoc/dx-mkdocs/in-progress/resources/tutorials/scriptapps/common-setup/post-deployment/add_scriptapp_to_page/).
