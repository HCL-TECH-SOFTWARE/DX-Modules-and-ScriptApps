# Woodburn Insurance - Login

![Woodburn Insurance - Login Script Application](../readme_imgs/Login.png)
## PreRequisites
...
1. Update the project [WBILogin/package.json](./package.json) file to point to the target DX core instance.
    ```
    {
        "config": {
           "dxclient": {
               "wcmContentName": "wbi-login",
               ...
               "protocol": "https",
               "hostname": "localhost",
               "port": "10041"
...
5. In case of errors, check the details in the DXClient logs in the WBILogin/store/logs/logger.log file.
6. Prepare your target DX page that will host the WBILogin ScriptApp. Follow the steps listed [here](https://pages.git.cwp.pnp-hcl.com/CWPdoc/dx-mkdocs/in-progress/resources/tutorials/scriptapps/common-setup/post-deployment/prepare_dx_page/).
7. Add the WBILogin ScriptApp (matching the wcmContentName in the package.json config) into the target DX test page. Follow the steps listed [here](https://pages.git.cwp.pnp-hcl.com/CWPdoc/dx-mkdocs/in-progress/resources/tutorials/scriptapps/common-setup/post-deployment/add_scriptapp_to_page/).
